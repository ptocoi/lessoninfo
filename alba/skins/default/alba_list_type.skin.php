...
<script type="text/javascript" src="<?php echo $alice['alba_path'];?>/skins/default/alba_list_type.skin.js"></script>
...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="NowLocation mt35 clearfix">
			<p> <a href="/">HOME</a> > <a href="<?php echo $alice['alba_path'];?>/">채용정보</a> > <a href="<?php echo $alice['alba_path'];?>/alba_list_type.php">업·직종별 채용정보</a> > <strong>업·직종별 채용정보</strong> </p>
		</div>
		<?php /* //navigation */ ?>
		...
		<div class="listWrap mt20">
			<h2 class="skip"><img src="../images/tit/job_tit_13.gif"  alt="업직종별 정규직 정보"></h2>
				...
				<div class="partSetWrap clearfix">
					...
					<div id="category_second">
						...
						if($mode=='search'){ // 검색일때 
							if($alba_type_1){
							$checked_arr = array();
							foreach($alba_type_1 as $type_key => $type_val){
						...
						?>
								...
								<?php } // category_middle_val if end. ?>
							</div>
						<?php
							}	// type foreach end.
						} else {
		...
		<div id="JobListForm" class="positionR mt30 clearfix">
			...
			<div class="ListFunc positionA" style="top:-5px; right:0;">
				<span class="choiceLink pr5">
					<span class="Link1"><a href="./alba_list_type.php?<?php echo $list_list['send_url'];?>&view_type=list#result"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink1_<?php echo (!$view_type||$view_type=='list')?'on':'off';?>.gif" class="vb" id="choiceLink_list"></a></span>
					<span class="Link2"><a href="./alba_list_type.php?<?php echo $list_list['send_url'];?>&view_type=gallery#result"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink2_<?php echo ($view_type=='gallery')?'on':'off';?>.gif" class="vb" id="choiceLink_gallery"></a></span>
				</span>
				<span>
					<select title="pagesize" name="sort" style="width:100px;" class="ipSelect2" onchange="list_sorting(this,'alba_list_type');">
