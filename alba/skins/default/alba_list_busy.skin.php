	...
	<div class="content2_wrap clearfix"> 
		...
		<div id="rightContent">
			...
			<div class="NowLocation mt35 clearfix">
				<p> <a href="/">HOME</a> > <a href="<?php echo $alice['alba_path'];?>/">채용정보</a> > <a href="<?php echo $alice['alba_path'];?>/alba_list_busy.php">일반 채용정보</a> > <strong>급구 채용정보</strong> </p>
			</div>
			<?php /* //navigation */ ?>

			<!-- 급구 정규직 정보 검색영역 -->
			<div class="listWrap mt20">
				<h2 class=""><img src="../images/tit/job_tit_06.gif"  alt="급구 정규직 정보"></h2>
		...
		<div id="JobListForm" class="positionR mt30 clearfix">
			...
			<div class="ListFunc positionA" style="top:-5px; right:0;">
				<span class="choiceLink pr5">
					<span class="Link1"><a href="./alba_list_busy.php?<?php echo $list_list['send_url'];?>&view_type=list"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink1_<?php echo (!$view_type||$view_type=='list')?'on':'off';?>.gif" class="vb" id="choiceLink_list"></a></span>
					<span class="Link2"><a href="./alba_list_busy.php?<?php echo $list_list['send_url'];?>&view_type=gallery"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink2_<?php echo ($view_type=='gallery')?'on':'off';?>.gif" class="vb" id="choiceLink_gallery"></a></span>
				</span>
				<span>
					<select title="pagesize" name="sort" style="width:100px;" class="ipSelect2" onchange="list_sorting(this,'alba_list_busy');">
				...
				<span>
					<select title="pagesize" name="page_rows" style="width:100px;" class="ipSelect2" onchange="list_rows(this,'alba_list_busy');">
			...
			<div id="list_view">
				...
				if($list_list['result']){
					...
					$no = $val['no'];
					$lists = $alba_user_control->get_alba_service($no,"sub_list",45);
				...
				<tr id="list_<?php echo $no;?>" style="display:;">
					...
					<td class="company"><a href="<?php echo $alice['alba_path'];?>/company_info.php?mb_id=<?php echo $val['wr_id'];?>"><span><?php echo $lists['company_name'];?> </span></a></td>
