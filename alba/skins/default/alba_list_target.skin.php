...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="NowLocation mt35 clearfix">
			<p> <a href="/">HOME</a> > <a href="<?php echo $alice['alba_path'];?>">채용정보</a> > <a href="<?php echo $alice['alba_path'];?>/alba_list_target.php">대상별 채용정보</a> > <strong><?php echo $navi_name;?></strong> </p>
		</div>
		<?php /* //navigation */ ?>
				...
				<div class="resumeContentWrap positionR clearfix">
					<div class="targetWrap positionR">
						<?php 
							...
							if($wr_target && $type){
								$checked = ($val['code']==$wr_target) ? 'checked' : '';
							} else {
								$checked = ($val['code']==$type) ? 'checked' : '';
							}
						?>
						<input type="radio" name="wr_target" id="wr_target_<?php echo $val['code'];?>" value="<?php echo $val['code'];?>" class="chk" <?php echo $checked;?>>
						<label for="wr_target_<?php echo $val['code'];?>"><?php echo $name;?></label>
						<?php } // job_target foreach end. ?>
					</div>
					<?php include_once "./views/_include/target_search.php";?>
				</div>
			</div>
		</div>
		</form>
		...
		<div id="JobListForm" class="positionR mt30 clearfix">
			...
			<div class="ListFunc positionA" style="top:-5px; right:0;">
				<span class="choiceLink pr5">
					<span class="Link1"><a href="./alba_list_target.php?<?php echo $list_list['send_url'];?>&view_type=list#result"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink1_<?php echo (!$view_type||$view_type=='list')?'on':'off';?>.gif" class="vb" id="choiceLink_list"></a></span>
					<span class="Link2"><a href="./alba_list_target.php?<?php echo $list_list['send_url'];?>&view_type=gallery#result"><img width="25" height="19" alt="" src="../images/icon/icon_choiceLink2_<?php echo ($view_type=='gallery')?'on':'off';?>.gif" class="vb" id="choiceLink_gallery"></a></span>
				</span>
				<span>
					<select title="pagesize" name="sort" style="width:100px;" class="ipSelect2" onchange="list_sorting(this,'alba_list_target');">
