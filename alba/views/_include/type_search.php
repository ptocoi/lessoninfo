		...
		<li class="resultSet clearfix" id="devResultSet">
			<div class="resultBox clearfix resultSetEmpty">
				...
				<dl class="selectBox clearfix" style="display:<?php echo ( $mode=='search' && ($category_top_val || $job_type_0 || $wr_area_0 || $wr_subway_0) )?'':'none';?>;">
					<dt class="pb5"><strong>선택된 조건(업직종,근무지역,역세권)</strong></dt>
					<dd>
						<ul class="selectList">
						<?php
						if( $mode=='search' ){
				...
				<p class="noSelect" style="display:<?php echo ( $mode=='search' && ($category_top_val || $job_type_0 || $wr_area_0 || $wr_subway_0) )?'none':'';?>;">선택된 조건(업직종,근무지역,역세권)이 없습니다.</p>
