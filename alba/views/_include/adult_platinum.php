...
<div id="platinum" class="style2 border<?php echo $design['adult_platinum_border'];?><?php echo ($design['adult_platinum_margin'])?' margin':'';?> number<?php echo $adult_platinum_row;?> mt25 clearfix">
	...
	<ul class="clearfix">
		...
		<?php 
			...
			$no = $val['no'];
			$list = $alba_user_control->get_alba_service($no,"adult_platinum");
		...
		<?php 
		if($platinum_rest != $adult_platinum_row){
