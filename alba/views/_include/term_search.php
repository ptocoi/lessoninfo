...
<div class="searchBox">
	<ul>
		...
		<li class="partSet clearfix" style="display:block;">
		<dl>
		...
		<li class="resultSet clearfix" id="devResultSet">
			<div class="resultBox clearfix resultSetEmpty">
				...
				<p class="noSelect" style="display:<?php echo ( $mode=='search' && ($category_top_val || $job_type_0 || $wr_area_0 || $wr_subway_0) )?'none':'';?>;">선택된 조건(근무지역,역세권,업직종)이 없습니다.</p>
