...
<div class="searchBox">
	<ul>
		<li class="workArea clearfix" style="display:block;">
		<dl>
		...
		<li class="resultSet clearfix" id="devResultSet">
			<div class="resultBox clearfix resultSetEmpty">
				...
				<dl class="selectBox clearfix" style="display:<?php echo ( $mode=='search' && ($category_top_val || $wr_subway_0 || $wr_jobtype_0) )?'':'none';?>;">
					<dt class="pb5"><strong>선택된 조건(역세권,근무지역,업직종)</strong></dt>
					<dd>
						<ul class="selectList">
						<?php
						if( $mode=='search' ){
				...
				<p class="noSelect" style="display:<?php echo ( $mode=='search' && ($category_top_val || $wr_subway_0 || $wr_jobtype_0) )?'none':'';?>;">선택된 조건(역세권,근무지역,업직종)이 없습니다.</p>
