<?php
		/*
		* /application/alba/alba_list_subway.php
		* @author Harimao
		* @since 2013/08/12
		...
		*/
		...
		$search_mode_sels = $_GET['alba_subway_sels'];
		$search_sel_1 = $_GET['alba_subway_1'];
		$search_sel_2 = $_GET['alba_subway_2'];
		...
		$pages = $utility->user_get_paging($page_rows, $page, $total_page,"./alba_list_subway.php?page_rows=".$page_rows."&".$list_list['send_url']."&page=");

		##
		# Include view
		if(is_file($alice['self'] . 'views/alba_list_subway.html'))
			include_once $alice['self'] . 'views/alba_list_subway.html';
		else
			$config->error_info( $alice['self'] . 'views/alba_list_subway.html' );
