<?php
		/*
		* /application/service/agreement.php
		* @author Harimao
		* @since 2013/10/01
		...
		*/
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/agreement.html'))
			include_once $alice['self'] . 'views/agreement.html';
		else
			$config->error_info( $alice['self'] . 'views/agreement.html' );
