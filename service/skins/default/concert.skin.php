...
<section id="content" class="content_wrap clearfix">
	<div class="content1_wrap clearfix"> 
		...
		<div class="NowLocation mt20 clearfix">
			<p> <a href="/">HOME</a> >  <strong>제휴문의</strong> </p>
		</div>
		<?php /* //navigation */ ?>
		<!--  content -->
		<div class="company mt30">
			<h2 class="pb5"> <img src="../images/tit/etc_tit_06.gif" alt="제휴문의"> </h2>
			<em class="titEm mb20">
				<ul>
			...
			<div class="registWrap mt10">
				...
				<tbody>
				<tr>
					<th scope="row"><label><img alt="필수입력사항" src="../images/icon/icon_b.gif" >제휴 문의분류</label></th>
					<td>
						<?php 
				...
				<tr>
					<th scope="row"><label><img alt="필수입력사항" src="../images/icon/icon_b.gif" >주요사업</label></th>
					<td><input type="text" maxlength="16" class="ipText" style="width:530px;" id="wr_biz" name="wr_biz" hname="주요사업" required></td>
				</tr>
				<tr>
					<th scope="row"> <label><img alt="필수입력사항" src="../images/icon/icon_b.gif" >사업제휴부분</label></th>
					<td><input type="text" maxlength="16" class="ipText" style="width:530px;" id="wr_biz_type" name="wr_biz_type" hname="사업제휴부분" required></td>
				</tr>
				<tr>
