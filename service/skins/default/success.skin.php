...
<section id="content" class="content_wrap clearfix">
	...
	<div class="NowLocation mt35 clearfix">
		<p> <a href="/">HOME</a> > <strong>다이렉트결제</strong> </p>
	</div>
	<?php /* //navigation */ ?>
		...
		<h2 class="skip"><?php echo ($get_payment['pay_method']=='bank')?'무통장입금대기':'결제완료';?></h2>
			...
			<div class="companyContentWrap">
				...
				<div class="memberResult mt50">
					<h2 class="pb20"> <img width="286" height="37" alt="<?php echo ($get_payment['pay_method']=='bank')?'무통장입금대기':'결제완료';?>" src="../images/basic/<?php echo ($get_payment['pay_method']=='bank')?'img_paymethod_end1_st.gif ':'img_paymethod_end1.gif';?>"> </h2>
					<div class="payWrap" >          
					<table>
					...
					<?php if($get_payment['pay_total'] && $get_payment['pay_method']=='bank'){ // 무통장 입금시?>
					<tr>
					...
					<div style="width:150px;" class="joinbtn clearfix mt30">
						<ul> 
							<li><div class="btn font_white bg_blueBlack"><a href="<?php echo $alice['main_path'];?>/">메인페이지</a></div></li>
						</ul>
					</div>
				</div>
				<!-- //상품결제 -->
