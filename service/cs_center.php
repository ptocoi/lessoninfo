<?php
		/*
		* /application/service/cs_center.php
		* @author Harimao
		* @since 2013/09/30
		...
		*/
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/cs_center.html'))
			include_once $alice['self'] . 'views/cs_center.html';
		else
			$config->error_info( $alice['self'] . 'views/cs_center.html' );
