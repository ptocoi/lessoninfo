		...
		*/
		class config extends DBConnection {
				...
				*/
				...
				var $local_num = array( "02" => "서울 (02)", "031" => "경기 (031)", "032" => "인천 (032)", "033" =>"강원 (033)", "041" =>"충남 (041)", "042" => "대전 (042)", "043" =>"충북 (043)", "044" => "세종 (044)", "051" =>"부산 (051)", "052" => "울산 (052)", "053" => "대구 (053)", "054" => "경북 (054)", "055" => "경남 (055)", "061" => "전남 (061)", "062" => "광주 (062)", "063" => "전북 (063)", "064" => "제주 (064)", "060" => "인터넷 (060)", "070" => "인터넷 (070)", "080" => "인터넷 (080)", "0502" => "평생번호(0502)" );

				var $tel_num = array( "02" , "031", "032", "033", "041", "042", "043", "044", "051", "052", "053", "054", "055", "061", "062", "063", "064", "060", "070", "080", "0502" );
				...
				function _user_header( $body_attr='', $css='', $css_media='', $plugin='', $view="" ){
					...
					global $is_debug, $is_demo, $is_html5, $is_member;	// 확인 변수
					...
					global $member;	// 회원 정보
						...
						if($view){	// view 가 있을땐 SEO 에 맞춘 헤더 정보 출력
							$result .= "<title>".stripslashes($env['site_title'])." :: ".$view['wr_subject']."</title>\n";
						} else {
							$result .= "<title>".stripslashes($env['site_title'])."</title>\n";
						}
						...
						//$result .= "<meta http-equiv=\"Imagetoolbar\" content=\"no\"  />\n";

						if($view){
							/*
							$result .= "<meta name=\"title\" content=\"".$view['wr_subject']."\" />\n";
							$result .= "<meta property=\"og:url\" content=\"http://news.netfu.co.kr/n_news/news/view.html?no=308\" />\n";
							$result .= "<link rel=\"image_src\" href=\"http://news.netfu.co.kr/n_news/peg/20130515132635_3231.jpg\" />\n";
							$result .= "<link rel=\"canonical\" href=\"http://news.netfu.co.kr/n_news/news/view.html?no=308\" />\n";
							*/
							$og_title = ($view) ? stripslashes($view['wr_subject']) : stripslashes($env['site_title']);
							$view_image = "http://" . $host_name . "data/logo/" . $logo['top'];
							//$result .= "<meta property=\"fb:app_id\" content=\"\" /> ";
							$result .= "<meta property=\"og:url\" content=\"http://".$host_name."alba/alba_detail.php?no=".$view['no']."\" />\n";
							$result .= "<meta property=\"og:title\" content=\"".$og_title."\"/>\n";
							$result .= "<meta property=\"og:type\" content=\"website\"/>\n";
							$result .= "<meta property=\"og:image\" content=\"".$view_image."\"/>\n";
							$result .= "<meta property=\"og:site_name\" content=\"".stripslashes($env['site_name'])."\"/>\n";
						}

						/*
						$result .= "<meta name=\"viewport\" content=\"width=990px\" />\n";
						$og_image = ($view) ? $view_image : "http://" . $_SERVER['HTTP_HOST']."/n_curat/data/logo/".$logo['top'];
						*/
						...
						if(!$design['site_color'])	// 사이트 색상 스킨사용시
							$result .= "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . $alice['css_path'] . "/" . $design['skin_color'] . ".css?t=".date('YmdH')."\"/>\n";
				...
				*/
				function get_tel_num( $num="" ){
						...
						foreach($this->tel_num as $tel){
							...
							$tel_num_option .= "<option value='".$tel."' ".$selected.">".$this->local_num[$tel]."</option>";
