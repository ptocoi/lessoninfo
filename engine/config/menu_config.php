<?php
		...
		*/
		...
		$menu['100'] = array(
			"eng_name" => "Service",
			"menus" => array(
				0 => array("code" => "100100", "name" => "채용공고 관리", 
				"sub_menu" => array(
					array("code" => "100101", "name" => "전체 채용공고 관리", "url" => "../alba/"),
					//array("code" => "100102", "name" => "사용자 등록 채용공고", "url" => "../alba/?is_admin=0"),
					//array("code" => "100103", "name" => "관리자 등록 채용공고", "url" => "../alba/?is_admin=1"),
					array("code" => "100102", "name" => "진행중인 채용공고", "url" => "../alba/employ_ing.php"),
					array("code" => "100103", "name" => "마감된 채용공고", "url" => "../alba/employ_end.php"),
					array("code" => "100104", "name" => "채용공고 등록", "url" => "../alba/?mode=insert"),
					array("code" => "100105", "name" => "신고 공고 관리", "url" => "../alba/employ_report.php"),
					array("code" => "100109", "name" => "서비스기간 만료 채용공고", "url" => "../alba/employ_serviced.php"),
					array("code" => "100106", "name" => "채용공고 댓글 관리", "url" => "../alba/employ_comment.php"),
					array("code" => "100107", "name" => "입사지원 관리", "url" => "../alba/employ_become.php"),
					array("code" => "100108", "name" => "채용공고 스크랩 관리", "url" => "../alba/employ_scrap.php"),
					),
				),
				...
				"sub_menu" => array(
					...
					array("code" => "100206", "name" => "첨부파일 관리", "url" => "../alba/resume_file.php"),
					),
				),
		...
		$menu['200'] = array(
			...
			"menus" => array(
				...
				"sub_menu" => array(
					//array("code" => "200201", "name" => "채용정보 설정", "url" => "../config/alba.php"),
				...
				"sub_menu" => array(
					...
					array("code" => "200302", "name" => "채용정보 항목 설정", "url" => "../config/register_form.php?type=alba_form"),
					...
					array("code" => "200305", "name" => "채용공고 신고 사유", "url" => "../config/category.php?type=alba_report_reason"),
					array("code" => "200306", "name" => "이력서 신고 사유", "url" => "../config/category.php?type=alba_resume_report_reason"),
					/*
					array("code" => "200306", "name" => "채용공고 신고 사유", "url" => "../config/board.php?type=reason_alba"),
				...
				"sub_menu" => array(
					...
					array("code" => "200403", "name" => "채용정보 분류", "url" => "../config/category.php?type=job_welfare", "subs" => 
						array(
							...
							"alba_profesional" => array("name" => "전문채용정보설정", "url" => "../config/category.php?type=alba_profesional"),
							//"job_report" => array("name" => "채용정보 신고사유", "url" => "../config/category.php?type=job_report"),
							//"biz_field" => array("name" => "채용정보 전문분야", "url" => "../config/category.php?type=biz_field"),
						),
					),
		...
		$menu['300'] = array(
			...
			"menus" => array(
				...
				"sub_menu" => array(
					...
					array("code" => "300504", "name" => "맞춤채용정보관리", "url" => "../member/custom_employ.php"),
					),
				),
		...
		$menu['400'] = array(
			...
			"menus" => array(
				...
				"sub_menu" => array(
					...
					array("code" => "400103", "name" => "채용공고기본로고", "url" => "../design/employ_logo.php"),
					),
				),

				1 => array("code" => "400200", "name" => "개별디자인관리",
				"sub_menu" => array(
					array("code" => "400201", "name" => "배너관리", "url" => "../design/banner.php?position=main_top"),
		...
		$menu['500'] = array(
			...
			"menus" => array(
				...
				"sub_menu" => array(
					array("code" => "500301", "name" => "채용공고패키지설정", "url" => "../payment/employ_package.php"),
					//array("code" => "500302", "name" => "채용공고패키지적용설정", "url" => "../payment/employ_package_set.php"),
					array("code" => "500303", "name" => "이력서패키지설정", "url" => "../payment/individual_package.php"),
		...
		$menu['600'] = array(
			...
			"menus" => array(
				...
				"sub_menu" => array(
					...
					array("code" => "600102", "name" => "게시물관리", "url" => "../board/list.php"),
