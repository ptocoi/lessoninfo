				...
				function auto_make_Mail( $type, $data ){
					...
					global $alba_company_control, $alba_individual_control, $alba_user_control;
						...
						if($company_list['total_count']){
							$resume_list = "<table width=\"100%\" style=\"font: 12px/170% dotum;text-align:center;\" cellpadding=\"0\" cellspacing=\"0\">";
						...
						if($individual_list['total_count']){
							$company_list = "<table width=\"100%\" style=\"font: 12px/170% dotum;text-align:center;\" cellpadding=\"0\" cellspacing=\"0\">";
