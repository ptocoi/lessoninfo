<?php
		...
		*/
		class alice_statistics_model extends DBConnection {
			...
			var $page_view_arr = array( "main" => "메인", "member" => "회원", "company" => "기업서비스", "individual" => "개인서비스", "alba" => "채용정보", "adult_alba" => "19정규직", "resume" => "인재정보", "map" => "지도검색", "service" => "서비스안내", "notice" => "공지사항", "board" => "커뮤니티", "search" => "통합검색" );
