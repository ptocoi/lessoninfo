<?php
		...
		*/
		class alice_service_model extends DBConnection {
			...
			var $service_title = array( 'main' => '메인 페이지', 'alba' => '채용정보 메인', 'alba_resume' => '인재정보 메인', 'alba_option' => '채용정보 옵션서비스', 'resume_option' => '인재정보 옵션서비스', 'etc' => '기타 서비스' ); // , 'adult_alba' => '19정규직'
			...
			var $service_lists = array( 
				'main' => array(	// 메인 페이지
					...
					'prime' => array( 'name' => '프라임', 'type' => 'box', 'is_gold' => true, 'is_logo' => true ),
					'grand' => array( 'name' => '그랜드', 'type' => 'box', 'is_gold' => true, 'is_logo' => true ),
					'banner' => array( 'name' => '배너형', 'type' => 'box', 'is_gold' => true ),
					'list' => array( 'name' => '리스트형', 'type' => 'list', 'is_gold' => true ),
					'focus' => array( 'name' => '포커스인재정보', 'type' => 'box', 'is_gold' => true ),
					'basic' => array( 'name' => '채용공고 일반리스트', 'type' => 'list', 'is_gold' => false ),
					'rbasic' => array( 'name' => '인재정보 일반리스트', 'type' => 'list', 'is_gold' => false ),
				),
				'alba' => array(		// 채용정보 메인
					'platinum' => array( 'name' => '플래티넘', 'type' => 'box', 'is_gold' => true, 'is_logo' => true ),
					'banner' => array( 'name' => '배너형', 'type' => 'box', 'is_gold' => true ),
			...
			var $service_name = array(
				'main' => array(
					'name' => '메인',
					'service' => array(
						'platinum' => '플래티넘', 'prime' => '프라임', 'grand' => '그랜드', 'banner' => '배너형', 'list' => '리스트형', 'focus' => '포커스인재정보', 'basic' => '일반리스트', 'resume_basic' => '일반리스트', 'resume_basic' => '일반리스트'
					),
				),
				'main_platinum' => array(
					'name' => '메인 플래티넘',
			...
			var $package_service = array( 
				"employ" => array( 
					"main_platinum" => "메인 플래티넘", 
					"main_platinum_gold" => "메인 플래티넘 골드", 
					"main_platinum_logo" => "메인 플래티넘 로고강조", 
					"main_prime" => "메인 프라임", 
					"main_prime_gold" => "메인 프라임 골드", 
					"main_prime_logo" => "메인 프라임 로고강조", 
					"main_grand" => "메인 그랜드", 
					"main_grand_gold" => "메인 그랜드 골드", 
					"main_grand_logo" => "메인 그랜드 로고강조", 
					"main_banner" => "메인 배너형", 
					"main_banner_gold" => "메인 배너형 골드", 
					"main_list" => "메인 리스트형", 
					"main_list_gold" => "메인 리스트형 골드", 
					"main_basic" => "메인 채용공고 일반리스트", 

					"alba_platinum" => "채용정보 플래티넘", 
					"alba_platinum_gold" => "채용정보 플래티넘 골드", 
					"alba_platinum_logo" => "채용정보 플래티넘 로고강조", 
					"alba_banner" => "채용정보 배너형", 
					"alba_banner_gold" => "채용정보 배너형 골드", 
					"alba_list" => "채용정보 리스트형", 
					"alba_list_gold" => "채용정보 리스트형 골드", 
					"alba_basic" => "채용정보 일반리스트", 
				...
				"individual" => array(
					"main_focus" => "메인 포커스 인재정보",
					"main_focus_gold" => "메인 포커스 인재정보 골드",
					"main_resume_basic" => "메인 인재정보 일반리스트",
					"alba_resume_focus" => "포커스 인재정보",
					"alba_resume_focus_gold" => "포커스 인재정보 골드",
					"resume_basic" => "인재정보 일반리스트",
