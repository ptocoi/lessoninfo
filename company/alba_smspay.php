<?php
		/*
		* /application/company/alba_smspay.php
		* @author Harimao
		* @since 2013/08/13
		* @last update 2014/07/08
		* @Module v3.5 ( Alice )
		* @Brief :: company alba resume online / email list
		...
		*/
		...
		$pages = $utility->user_get_paging($page_rows, $page, $total_page,"./alba_smspay.php?page_rows=".$page_rows."&".$list['send_url']."&page=");

		##
		# Include view
		if(is_file($alice['self'] . 'views/alba_smspay.html'))
			include_once $alice['self'] . 'views/alba_smspay.html';
		else
			$config->error_info( $alice['self'] . 'views/alba_smspay.html' );
