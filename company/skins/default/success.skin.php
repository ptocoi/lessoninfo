...
<section id="content" class="content_wrap clearfix">
	...
	<div class="NowLocation mt35 clearfix">
		<p> <a href="/">HOME</a> > <a href="<?php echo $alice['company_path'];?>/">기업서비스</a> > <strong>결제완료</strong> </p>
	</div>
	<?php /* //navigation */ ?>
		...
		<h2 class="skip"><?php echo ($get_payment['pay_method']=='bank')?'무통장입금대기':'결제완료';?></h2>
			...
			<div class="companyContentWrap">
				...
				<div class="memberResult mt50">
					<h2 class="pb20"> <img <?php if($get_payment['pay_method']!='bank'){ ?>width="286" height="37" <?php } ?>alt="<?php echo ($get_payment['pay_method']=='bank')?'무통장입금대기':'결제완료';?>" src="../images/basic/<?php echo ($get_payment['pay_method']=='bank')?'img_paymethod_end1_st.gif ':'img_paymethod_end1.gif';?>"> </h2>
					<div class="payWrap" >          
					<table>
					...
					<?php if($get_payment['pay_total'] && $get_payment['pay_price'] && $get_payment['pay_method']=='bank'){ // 무통장 입금시?>
					<tr>
