...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="listWrap positionR mt20">
			...
			<h3 style="padding:10px;" class="font11 fongrb">맞춤 인재 정보를 설정하시면  원하는 형태의 인재정보를 이메일이나 SMS 문자를 통해 수신하실 수 있습니다.<a href="/company/alba_customized.php"><img class="vm positionR" style="left:115px;"src="/images/tit/more_job.gif"></a></h3>
			...
			<div class="personContentWrap"><!--  컨텐츠  -->
				...
				<div class="customList1 mb30"> 
					...
					<div style="border-top:1px solid #dddddd;"class="pt10 mb10">
						...
						<span class="pl10">
							<input name="wr_type" id="wr_type_sms" type="radio" value="sms" checked> <label for="wr_type_sms">SMS</label>
							<input name="wr_type" id="wr_type_lms" type="radio" value="lms" <?php echo ($wr_type=='lms')?'checked':'';?>> <label for="wr_type_lms">LMS</label>
						</span>
					</div>
