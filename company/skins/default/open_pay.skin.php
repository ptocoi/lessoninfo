...
<script type="text/javascript" src="<?php echo $alice['company_path'];?>/skins/default/open_pay.skin.js"></script>
...
<section id="content" class="content_wrap clearfix">
	...
	<div class="listWrap positionR mt20">
		...
		<input type="hidden" name="pay_type" value="resume_open" id="pay_type"/>
			...
			<div id="listForm" class="mainTopBorder positionR mt30 clearfix">
				...
				<div class="customList1 mb10">
					...
					<tr id="etc_open">
						...
						<td class="tl">
							<span>
								오늘 +<?php echo $etc_open_dates[0].$service_control->_unit($etc_open_dates[1]);?> 
								(<?php echo date('Y.m.d');?>~<?php echo date('Y.m.d',strtotime("+".$etc_open_dates[0]." ".$etc_open_dates[1]));?>)
							</span>
						</td>
						<td class="tc">
