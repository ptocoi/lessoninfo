		...
		<td align="left" valign="top">
			...
			<tr>
				...
				<td height="327" align="left" class="sandBOX" valign="top" style="padding-top: 3px; padding-left: 10px;">
					...
					<tbody>
					<tr>
						<td width="88" align="left"><img class="pr5" src="/images/icon/note_tlt_6.gif"><b>받은쪽지함</b></td>
					...
					<td align="left" class="pt5" colspan="2">
						...
						<?php 
						if($receive_memo['total_count']){
							foreach($receive_memo['result'] as $val){
							...
							<td class="tl pl5">
								<div>
									<ul class="texli" style="list-style: none; padding-left: 0px;">
										...
										<li style="width"><a href="./memo_read.php?no=<?php echo $val['no'];?>&kind=recv"><?php echo $utility->str_cut($val['wr_memo'],25);?></a></li>
									</ul>
								</div>
							</td>
