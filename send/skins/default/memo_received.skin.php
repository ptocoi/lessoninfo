		...
		<td align="left" valign="top">
			...
			<tr>
				...
				<td height="327" align="left" class="sandBOX" valign="top" style="padding-top: 3px; padding-left: 10px;">
					...
					<tbody>
					<tr>
						<td width="88" align="left"><img class="pr5" src="/images/icon/note_tlt_6.gif"><b>보낸쪽지함</b></td>
					...
					<td align="left" class="pt5" colspan="2">
						...
						<colgroup><col width="77px;"><col width="160px;"><col width="95px;"><col width="95px;"><col width="50px;"></colgroup>
						<tr class="SNDform" style="text-align:center;">
							<td class="pt5">받는사람</td>
							<td>내용</td>
							<td>보낸시간</td>
							<td>읽은시간</td>
							<td>삭제</td>
						...
						<?php 
						if($send_memo['total_count']){
							foreach($send_memo['result'] as $val){
							$get_member = $member_control->get_member($val['wr_recv_mb_id']);
							...
							<td class="tl pl5">
								<div>
									<ul class="texli" style="list-style: none; padding-left: 0px;">
										...
										<li style="width"><a href="./memo_read.php?no=<?php echo $val['no'];?>&kind=send"><?php echo $utility->str_cut($val['wr_memo'],24);?></a></li>
									</ul>
								</div>
							</td>
							<td class="font11 tc"><?php echo $send_datetime;?></td>
							<td class="font11 tc"><?php echo $read_datetime;?></td>
