<?php
		/*
		* /application/send/memo_from.php
		* @author Harimao
		* @since 2015/03/16
		...
		*/
		...
		// paging
		$total_page = $receive_memo['total_page'];
		$pages = $utility->user_get_paging($page_rows, $page, $total_page,"./memo_from.php?page_rows=".$page_rows."&page=");
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/memo_from.html'))
			include_once $alice['self'] . 'views/memo_from.html';
		else
			$config->error_info( $alice['self'] . 'views/memo_from.html' );
