<div id="mPlatinum">
	...
	<ul class="boxWrap clearfix positionR" id="sub_box">
	<?php
	$li_class = "";
...
<div class="paging mt20 mb50">
	<span class="page">
	<span id="sub_box_first"></span>
	<?php
		$sub_box_pages = str_replace("처음", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $sub_box_pages);
		$sub_box_pages = str_replace("이전", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $sub_box_pages);
		$sub_box_pages = str_replace("다음", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $sub_box_pages);
		$sub_box_pages = str_replace("맨끝", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $sub_box_pages);
		$sub_box_pages = preg_replace("/<b>([0-9]*)<\/b>/", "$1", $sub_box_pages);
		echo $sub_box_pages;
	?>
	</span>
</div>
