...
<div class="location clearfix">
	<h2 class="clearfix">
		...
		<div class="styled-select list1  clearfix positionR shadowBox">
			...
			<select class="h30" style="" id="wr_area0" name="wr_area0" title="시/도" onchange="area_sel_first(this,'wr_area1');">
		...
		<div class="styled-select list2 clearfix positionR shadowBox" style="width:97px;height:30px !important">
			<img alt="" src="../images/btn/btn_down2.png" class="bg_color1">
			<div id="wr_area1_display">
				<select class="h30" id="wr_area1" name="wr_area1" title="시/구/군" style="height:30px" onchange="area_sel_first(this,'wr_area2');">
		...
		<div class="styled-select list3 clearfix positionR shadowBox">
			<img alt="" src="../images/btn/btn_down2.png" class="bg_color1">
			<div id="wr_area2_display">
				<select class="h30" id="wr_area2" name="wr_area2" title="읍/면/동">
	...
	<!-- 상세검색 리스트 -->
	<div class="detailSearchBox bg_color1 shadowBox" style="display:none;" >
		...
		<div class="styled-radio bg_color2">
			<!-- <span>
				<input type="radio" id="ra_career_type_0" name="career_type">
				<label for="ra_career_type_0">이하</label>
			</span>
			<span>
				<input type="radio" id="ra_career_type_2" name="career_type">
				<label for="ra_career_type_2">이상</label>
			</span> -->
			<span>
