...
(function ($) {
	...
	$.fn.touchSlider = function (settings) {
		...
		return this.each(function () {
			...
			//alert( $('.jobBtnWrap').css("width") );
			this._width = ($('.jobBtnWrap').length) ? parseInt( $('.jobBtnWrap').css("width") ) : parseInt( $('.resumeBtnWrap').css("width") );
		...
		animate : function (d, btn_click, me) 
        {
            ...
            if(_this._drag || !_this._scroll || btn_click) 
            {
				...
				for(var i=0; i<_this._len; ++i) 
                {
					...
					_this._list.eq(i).animate({"left": _this._pos[i] + "px"}, _this._speed);
				}
