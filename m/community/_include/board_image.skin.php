<div class="comWrap">
	...
	<?php 
		...
		preg_match("/<img[^>]*src=[\"']?([^>\"']+)[\"']?[^>]*>/i", stripslashes($list['wr_content']), $_img);
	...
	?>
		<li class="photoList positionR">
			<dl class="clearfix">
				<div><a href="../community/view.html?bo_table=<?php echo $bo_table;?>&wr_no=<?php echo $list['wr_no'];?>"><img src="<?php echo $img;?>" style="width:169px;height:100px;"></a></div>
				<dt> 
