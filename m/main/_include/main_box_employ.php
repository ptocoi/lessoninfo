<div id="mPlatinum">
	<h2><em class="icon"><img class="bg_color1" src="../images/icon/icon_mPlatinum1.png"></em><span>박스형 채용정보</span></h2>
	<ul class="boxWrap clearfix positionR" id="main_box">
	<?php
	$li_class = "";
...
<div class="paging mt20 mb50">
	<span class="page">
	<span id="main_box_first"></span>
	<?php
		$main_box_pages = str_replace("처음", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $main_box_pages);
		$main_box_pages = str_replace("이전", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $main_box_pages);
		$main_box_pages = str_replace("다음", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $main_box_pages);
		$main_box_pages = str_replace("맨끝", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $main_box_pages);
		$main_box_pages = preg_replace("/<b>([0-9]*)<\/b>/", "$1", $main_box_pages);
		echo $main_box_pages;
		/*
		if($main_box_pages){
			echo "<span class=\"location\">[<strong>".$main_box_pages."</strong>/".$total_page."]</span>";
		}
		*/
	?>
	</span>
