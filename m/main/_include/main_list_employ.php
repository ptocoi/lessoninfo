<div id="mPrime">
	...
	<ul class="boxWrap clearfix positionR" id="main_list">
	<?php
	$li_class = "";
...
<div class="paging mt20 mb50">
	<span class="page">
	<span id="main_list_first"></span>
	<?php
		$main_list_pages = str_replace("처음", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $main_list_pages);
		$main_list_pages = str_replace("이전", "<img src=\"../images/btn/btn_leftArrow2.png\" class=\"bg_color1\">", $main_list_pages);
		$main_list_pages = str_replace("다음", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $main_list_pages);
		$main_list_pages = str_replace("맨끝", "<img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\"><img src=\"../images/btn/btn_rightArrow2.png\" class=\"bg_color1\">", $main_list_pages);
		$main_list_pages = preg_replace("/<b>([0-9]*)<\/b>/", "$1", $main_list_pages);
		echo $main_list_pages;
	?>
	</span>
</div>