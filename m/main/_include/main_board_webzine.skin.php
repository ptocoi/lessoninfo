<div class="mb50 comWrap">
	<h2>
	<em class="icon"><img  class="bg_color1" src="../images/icon/icon_mList1.png"></em>
	<span><?php echo $bo_subject;?><em class="pl5 text_color1">(<?php echo $bo_write_count;?>건)</em></span>
		...
		<li class="webzineList positionR">
			<dl class="clearfix">
				<div style="position:absolute; left:0;top:0;">
					<a href="../community/view.html?bo_table=<?php echo $bo_table;?>&wr_no=<?php echo $list['wr_no'];?>"><img src="<?php echo $img;?>" style="width:80px;height:47px;"></a>
				</div>
				<dt> 
