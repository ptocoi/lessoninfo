<?php
		...
		*/
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/print_alba_resume.html'))
			include_once $alice['self'] . 'views/print_alba_resume.html';
		else
			$config->error_info( $alice['self'] . 'views/print_alba_resume.html' );
