...
<ul style="border:2px solid #d9d9d9;width:600px;text-align:center;display: table;
        margin-left: auto;
        margin-right: auto;">
<li class="font pt10 pb10"><strong><?php echo $env['site_name'];?></strong> 이메일을 <strong class="red">수신거부</strong> 하시겠습니까?</li>
...
<li class="m10">
<a href="./email_opt.php?email=<?=$sending_email;?>"><div class="b wht grablue" style="width:80px;display:inline-block;">예</div></a>
<a href="#" onClick="javascript:self.close();"><div class="b ml10 gragray" style="width:80px;display:inline-block;">아니오</div></a>
</li>
</ul>
