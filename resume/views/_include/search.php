...
<form method="get" name="list_SearchFrm" action="<?php echo $_SERVER['PHP_SELF'];?>" id="list_SearchFrm">
	...
	<li class="Info clearfix">
		...
		<div class="age">
			<dl>
				...
				<dd>
					<span>
						<input type="text" name="wr_age[]" style="width:30px;" id="wr_age_high" class="ipText2" maxlength="3" value="<?php echo $wr_age[0];?>" <?php echo ($wr_age_limit)?'disabled':'';?>> 세↑ ~ <input type="text" name="wr_age[]" style="width:30px;" id="wr_age_low" class="ipText2" maxlength="3" value="<?php echo $wr_age[1];?>" <?php echo ($wr_age_limit)?'disabled':'';?>> 세↓
					</span>
					<span class="inc">
