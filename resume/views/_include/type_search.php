...
<div class="searchBox">
	...
	<li class="Info clearfix">
		...
		<div class="career">
			<dl>
				...
				<dd>
					<input type="radio" id="wr_career_use_0" name="wr_career_use" value="0" <?php echo ($wr_career_use=='0')?'checked':'';?>>
	...
	<li class="resultSet clearfix">
		<div class="resultBox clearfix">
			...
			<!-- 선택조건 있을때 display-->
			<dl class="selectBox clearfix" style="display:<?php echo ( $mode=='search' && ($category_top_val || $wr_jobtype_0) )?'':'none';?>;">
				<dt class="pb5"><strong>선택된 조건(희망 업직종, 희망 근무지역)</strong></dt>
				<dd>
					<ul class="selectList">
						<?php
						if( $mode=='search' ){
			...
			<p class="noSelect" style="display:<?php echo ( $mode=='search' && ($category_top_val || $wr_jobtype_0) )?'none':'';?>;">선택된 조건(희망 업직종, 희망 근무지역)이 없습니다.</p>
			<p class="btnAction">
