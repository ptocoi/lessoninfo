<?php
		/*
		* /application/resume/alba_resume_term.php
		* @author Harimao
		* @since 2013/08/13
		...
		*/
		...
		$pages = $utility->user_get_paging($page_rows, $page, $total_page,"./alba_resume_term.php?page_rows=".$page_rows."&".$list_list['send_url']."&page=");

		##
		# Include view
		if(is_file($alice['self'] . 'views/alba_resume_term.html'))
			include_once $alice['self'] . 'views/alba_resume_term.html';
		else
			$config->error_info( $alice['self'] . 'views/alba_resume_term.html' );
