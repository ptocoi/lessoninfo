...
<script type="text/javascript" src="<?php echo $alice['resume_path'];?>/skins/default/alba_resume_area.skin.js"></script>
...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="NowLocation mt35 clearfix">
			<p> <a href="/">HOME</a> > <a href="<?php echo $alice['resume_path'];?>/">인재정보</a> > <a href="<?php echo $alice['resume_path'];?>/alba_resume_list.php">일반 인재정보</a> > <strong>지역별 인재정보</strong> </p>
		</div>
		<?php /* //navigation */ ?>
