...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="NowLocation mt35 clearfix">
			<p> <a href="/">HOME</a> > <a href="<?php echo $alice['resume_path'];?>/">인재정보</a> > <a href="<?php echo $alice['resume_path'];?>/alba_resume_specialty.php">능력별 인재정보</a> > <strong>자격증별 인재정보</strong> </p>
		</div>
		<?php /* //navigation */ ?>
		...
		<div class="listWrap mt20">
			<h2 class=""><img src="../images/tit/resume_tit_13.gif" alt="자격증별인재정보"></h2>
			<div class="resumeContentWrap positionR mt10 clearfix">
				<div class="licenseTypeWrap clearfix">
					<div class="licenseSearch">
					<strong><span class="text">자격증명 검색</span>:</strong>
					<input type="text" maxlength="20" style="width:200px;" class="ipText2" id="alba_search_license" name="search_license" value="<?php echo urldecode($search_license);?>">
                    <a class="button" onclick="searchFrm_submit();"><span>검색</span></a>
				</div>
				</div>
				<div class="searchBox">
						<ul>
								...
								<dl>
									...
									<dd>
										...
										<span id="wr_career_display" style="display: <?php echo ($wr_career_use=='2')?'':'none';?>;">
											<select class="ipSelect" name="wr_career" id="wr_career" hname="경력" option="select">
						...
						<!-- <li class="search clearfix">
							<dl>
								...
								<dd class="keywordSearch">
									<input type="text" maxlength="20" style="width:400px;" class="ipText2" id="alba_search_license" name="search_license" value="<?php echo urldecode($search_license);?>">
								</dd>
							</dl>
						</li> -->
						...
						<li class="resultSet clearfix">
							<div class="resultBox clearfix">
								...
								<p class="btnAction">
									<a href="javascript:searchFrm_submit();" class="searchBtn"><span class="Btn bg_color4">검색</span></a>
									<a class="resetBtn" onclick="searchFrm_reset();"><span class="Btn">초기화</span></a>
								</p>
							</div>
						</li>
		...
		<div id="listForm" class="positionR mt30 clearfix">
			...
			<span class="positionA" style="top:-5px; right:0;">
				<select title="pagesize" name="page_rows" style="width:100px;" class="ipSelect2" onchange="list_rows(this,'alba_resume_license');">
