...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<p> <a href="/">HOME</a> > <a href="<?php echo $alice['resume_path'];?>/">인재정보</a> > <a href="<?php echo $alice['resume_path'];?>/alba_resume_target.php">대상별 인재정보</a> > <strong>청소년</strong> </p>
		</div>
		<?php /* //navigation */ ?>

		<!--  대상별인재 검색영역 -->
		<div class="listWrap mt20">
			<h2 class=""><img src="../images/tit/resume_tit_09.gif" width="129" height="21" alt="대상별 인재정보"></h2>
			<div class="resumeContentWrap positionR mt10 clearfix">
				<div class="targetWrap positionR">
					<input type="radio" checked="checked" name="target" id="" value="" class="chk">
					<label>청소년</label>
					<input type="radio" name="target" id="" value="" class="chk">
					<label>대학생</label>
					<input type="radio" name="target" id="" value="" class="chk">
					<label>주부</label>
					<input type="radio" name="target" id="" value="" class="chk">
					...
					<ul>
						...
						<li class="workArea clearfix">
							<dl>
								...
								<dd class="itemBoxArea">
									...
									<div class="mt5 middleArea border_color1 clearfix" style="display:none;">
										<ul class="listArea">
									...
									<div class="mt5 smallArea border_color1 bg_color2 clearfix" style="display:none;">
										<ul class="listArea">
						...
						<li class="partSet clearfix">
							<dl>
								...
								<dd class="itemBoxPartSet">
									...
									<div class="mt5 middlePartSet border_color1 clearfix" style="display:none;">
										<ul class="listArea">
						...
						<li class="resultSet clearfix">
							<div class="resultBox">
								...
								<p class="btnAction">
									<a href="#" class="searchBtn"><span class="Btn bg_color4">검색</span></a>
		...
		<div id="listForm" class="positionR mt30 clearfix">
			...
			<tr>
				<td class="name">
					<span>김○○<em class="photo"><img class="vb pb2" src="../images/icon/icon_photo1.gif" width="16" height="16"></em></span>
					<span class="block">(男 <span>30</span>세)</span>
				</td>
				<td class="title">
					<a href="/resume/Detail.asp?adid=4619612">
						<span class="title">알바 정규직 원합니다</span>
						<span class="kind text_color1">제조·가공,포장·조립,품질검사·관리</span>
						<span class="career"><img  class="vb"alt="경력" src="../images/icon/icon_career.gif" width="23" height="14"> 	
							<span>1</span>년 	<span>4</span>개월</span>
							<span class="license"><img class="vb" alt="자격증" src="../images/icon/icon_license.gif" width="36" height="14"> 자동차운전면허
						</span>
					</a>
				</td>
				<td class="icons">
					<div><a target="_blank" href="#" class="window" id=""><img class="bg_orang" width="13" height="13" src="../images/icon/icon_newWindow.png" alt="새창으로 열기"></a></div>
					<div><a href="#" class="star" id=""><img class="bg_orang" width="13" height="13" src="../images/icon/icon_star.png" alt="공고스크랩"></a></div>
					<div><a href="#" class="plus" id=""><img class="bg_orang" width="13" height="13" src="../images/icon/icon_plus.png" alt="상세보기"></a></div>
				</td>
				<td class="pay">
