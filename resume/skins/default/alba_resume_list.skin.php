...
<script type="text/javascript" src="<?php echo $alice['resume_path'];?>/skins/default/alba_resume_list.skin.js"></script>
...
<section id="content" class="content_wrap clearfix">
	...
	<div class="content2_wrap clearfix"> 
		...
		<div class="NowLocation mt35 clearfix">
			<p> <a href="/">HOME</a> > <a href="<?php echo $alice['resume_path'];?>/">인재정보</a> > <a href="<?php echo $alice['resume_path'];?>/alba_resume_list.php">일반 인재정보</a> > <strong>전체 인재정보</strong> </p>
		</div>
		<?php /* //navigation */ ?>

		<!--  인재정보 전체 검색영역 -->
		<div class="listWrap mt20">
			<h2 class=""><img src="../images/tit/resume_tit_04.gif"  alt="전체인재정보"></h2>
		...
		<div id="listForm" class="positionR mt30 clearfix">
			...
			<span class="positionA" style="top:-5px; right:0;">
				<select title="pagesize" name="page_rows" style="width:100px;" class="ipSelect2" onchange="list_rows(this,'alba_resume_list');">
