<?php
		/*
		* /application/resume/alba_resume_list.php
		* @author Harimao
		* @since 2013/08/13
		...
		*/
		...
		$pages = $utility->user_get_paging($page_rows, $page, $total_page,"./alba_resume_list.php?page_rows=".$page_rows."&".$list_list['send_url']."&page=");
