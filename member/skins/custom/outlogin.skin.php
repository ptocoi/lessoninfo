...
<?php } else { // 로그인 전 ?>
	<div style="display:block;">
		...
		<ul class="selectMem clearfix">
			<li><input type="radio" class="chk" value="individual" name="mb_type" id="mb_individual" checked> <label for="mb_individual">선생님</label></li>
			<li class="pl5"><input type="radio" class="chk" value="student" name="mb_type" id="mb_student"> <label for="mb_student">학생(학부모)</label></li>
			<li class="pl5"><input type="radio" class="chk" value="company" name="mb_type" id="mb_company"> <label for="mb_company">회사(업체)</label></li>
