...
<style>
.hphone_block{ display:<?php echo ($use_hphone) ? '':'none';?>;}
</style>
...
<section id="content" class="content_wrap clearfix">
	<div class="content1_wrap clearfix"> 
		...
		<div class="NowLocation mt20 clearfix">
			<p> <a href="/">HOME</a> > <strong>비밀번호 찾기</strong> </p>
		</div>
		<?php /* //navigation */ ?>
		...
		<div class="secNav mt10 clearfix">
			<ul>
				<li class="mn1 off"><a href="./find_id.php"><em><img src="../images/basic/img_step7_off.png" width="69" height="31" alt="step1"></em><img src="../images/basic/img_tit_search_step1_off.png" width="84" height="19" alt="아이디찾기"></a></li>
				<li class="mn2 on"><a href="./find_pw.php"><em><img src="../images/basic/img_step8_on.png" width="69" height="31" alt="step2"></em><img src="../images/basic/img_tit_search_step2_on.png" width="100" height="19" alt="비밀번호찾기"></a></li>
				<li class="mn3 Rend"></li>
			</ul>
		</div>
		<?php /* //sec navigation */ ?>

		<div class="globalpwSearchWrap mt10">
			<div class="pwSearchWrap clearfix">
			<h2 class="mt40 pb5"><img width="140" height="26" alt="비밀번호찾기" src="../images/tit/member_tit_03.gif"></h2>
				<div class="text mt20 mb20"><strong>아래의 찾기 방법 중 하나를 선택해 주세요.</strong><br /></div>

				<ul class="pwSearchBoxWrap clearfix">
					<li class="companySearch positionR clearfix">
					<dl>
						<dt><img width="178" height="21" alt="기업회원 비밀번호찾기" src="../images/tit/member_tit3_01.gif"></dt>
						<dd>
							<?php if($use_ipin){ ?>
							...
							<?php } ?>
							<?php if($use_hphone){ ?>
								<div class="button positionA" style="display:none; text-align:center; bottom:15px; left:50%; margin-left:-80px;" id="company_hphone_button">
									<a href="javascript:certify_hphone();"><span><strong>기업회원 비밀번호찾기</strong></span></a>
								</div>
							<?php }?>
							<ul>
							...
							<li class="ipinBox" style="display:none;" id="certify_type_ipins">
								<span><em class="text_blue">아이핀(I-PIN)인증</em>을 통해 회원님의<br /> <strong>비밀번호를 확인</strong>하실 수 있습니다.</span>
							</li>
							...
							<div class="button positionA" style="display:<?php echo (!$use_pin&&!$use_hphone)?'':'none';?>; text-align:center; bottom:30px; left:50%; margin-left:-80px" id="company_hphone_button">
								<a href="javascript:company_find_pw();"><span><strong>기업회원 비밀번호찾기</strong></span></a>
							</div>
							<?php } ?>
					...
					<li class="personSearch positionR clearfix">
					<dl>
						<dt><img width="178" height="21" alt="개인회원 비밀번호찾기" src="../images/tit/member_tit3_02.gif"></dt>
						<dd>
						<div class="button positionA individual_button" style="display:<?php echo ($use_ipin && $use_hphone)?'none':'';?>; text-align:center; bottom:30px; left:50%; margin-left:-80px" id="individual_email_button">
								<a href="javascript:individual_find_id_email();"><span><strong>개인회원 비밀번호찾기</strong></span></a>
							</div>
							
							<div class="button positionA individual_button" style="display:none; text-align:center; bottom:15px; left:50%; margin-left:-80px" id="individual_hphone_button">
								<a href="javascript:individual_certify_hphone();"><span><strong>개인회원 비밀번호찾기</strong></span></a>
							</div>
							...
							<div class="button positionA individual_button" style="display:none; text-align:center; bottom:30px; left:50%; margin-left:-80px" id="individual_foreigner_button">
								<a href="#"><span><strong>외국인 비밀번호찾기</strong></span></a>
							</div>
							<ul class="clearfix">
							<?php if($use_ipin || $use_hphone){ ?>
							<li class="radio">
							...
							<li class="emailBox" style="display:<?php echo ($use_ipin || $use_hphone)?'none':'';?>;" id="individual_box">
								<ul class="Data">
								...
								<li class="boxes hphone_box ipin_box hphone_block">
									<span><label class="title"><strong>생년월일</strong></label></span>
									<span>
								...
								<li class="boxes hphone_box hphone_block">
									<span><label class="title"><strong>성별</strong></label></span>
								...
								<li class="boxes hphone_box hphone_block">
									<span class="vt"><label class="title"><strong>휴대폰</strong></label></span>
									...
									<select title="휴대폰 국번" name="certify_mobile_0" id="individual_certify_mobile_0" style="width:58px;" class="ipSelect">
										<?php for($i=0;$i<$hp_num_cnt;$i++){?>
										<option value="<?php echo $config->hp_num[$i];?>"><?php echo $config->hp_num[$i];?></option>
										<?php } ?>
									</select>
								...
								<li class="boxes foreigner_box" style="display:none;">
							...
							<li class="boxes ipinBox" style="display:none; text-align:center;" id="ipin_box">
								<span ><em class="text_blue">아이핀(I-PIN)인증</em>을 통해 회원님의<br /> <strong>비밀번호를 확인</strong>하실 수 있습니다.</span>
							</li>
...
<form name="ipinStepFrm" action="<?php echo $alice['okname_path'];?>/ipin/find_password1.php" method="post"></form>
<?php } ?>

<?php if($use_hphone){ // 휴대폰 인증을 사용한다면 ?>
<form name="cnFrm" action="<?php echo $alice['okname_path'];?>/hs_cnfrm/find_password1.php" method="post" id="cnFrm">
