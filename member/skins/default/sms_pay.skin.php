...
<script type="text/javascript" src="<?php echo $alice['member_path'];?>/skins/default/sms_pay.skin.js"></script>
...
<section id="content" class="content_wrap clearfix">
	...
	<div class="listWrap positionR mt20">
		...
		switch($pg_company){
			case 'inicis':	## 이니시스
				include_once "../".$mb_type."/views/_include/inicis.php";
			break;
			case 'allthegate':	## 올더게이트
				include_once "../".$mb_type."/views/_include/allthegate.php";
			break;
			case 'kcp':	## KCP
				include_once "../".$mb_type."/views/_include/kcp.php";
			break;
