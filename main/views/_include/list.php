...
<div id="list" class="style<?php echo $main_left;?> mt30 clearfix">
	...
	<ul class="clearfix">  
		...
		<?php 
			...
			$no = $val['no'];
			$list = $alba_user_control->get_alba_service($no,"main_list",50);
		?>
		<li class="bth <?php echo $list['gold_service'];?>" id="list_list_<?php echo $no;?>">
