...
<div id="prime" class="style<?php echo $main_left;?> border<?php echo $design['main_prime_border'];?><?php echo ($design['main_prime_margin'])?' margin':'';?> number<?php echo $main_prime_row;?> mt25 clearfix">
	...
	<ul class="clearfix">
		...
		<?php 
			...
			$no = $val['no'];
			$list = $alba_user_control->get_alba_service($no,"main_prime");
			switch($design['main_prime']){
				case '01':	// 프라임 디자인 1
		?>
				...
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dt> 
							<a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>">
							<span class="logo"><?php echo $list['wr_logo'];?></span>
							<span style="text-align:center;" class="logo_tit"><?php echo $list['company_name'];?></span>
							</a> 
						</dt>
				...
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dt> 
							<a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>">
							<span class="logo"><?php echo $list['wr_logo'];?></span>
							<span style="text-align:right;" class="logo_tit"><?php echo $list['company_name'];?></span>
							</a> 
						</dt>
						<dd style="text-align:right;" class="text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd style="text-align:right;" class="text2 clearfix">
							<span class="pay">
								<?php
								if($list['wr_pay_conference']){
									echo "<strong>".$alba_user_control->pay_conference[$list['wr_pay_conference']]."</strong>";
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dd style="color:#333333;"class="b logo_tit"><?php echo $list['company_name'];?></dd>
						<dd class="text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd class="text2 clearfix">
							<span class="pay">
								<?php
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dd style="text-align:center;color:#333333;"class="b logo_tit"><?php echo $list['company_name'];?></dd>
						<dd style="text-align:center;" class="text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd style="text-align:center;" class="text2 clearfix">
							<span class="pay">
								<?php
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dd style="text-align:right;color:#333333;padding-top: 18px;"class="b logo_tit"><?php echo $list['company_name'];?></dd>
						<dd style="text-align:right;" class="text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd style="text-align:right;" class="text2 clearfix">
							<span class="pay">
								<?php
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">				
						<dd style="text-align:right;" class="pt20 text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd style="text-align:right;" class="text2 clearfix">
							<span class="pay">
								<?php
								if($list['wr_pay_conference']){
						...
						<dd class="icons">
							...
							<dt class="pr5"> 
							<a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>">
							<span style="text-align:right;"class="pt20 b logo"><?php echo $list['company_name'];?></span>					
							</a> 
						</dt>
					</dl>
				</li>
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">				
						<dd style="text-align:left;" class="pt20 text1"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd style="text-align:left;" class="text2 clearfix">
							<span class="pay">
								<?php
								if($list['wr_pay_conference']){
									echo "<strong>".$alba_user_control->pay_conference[$list['wr_pay_conference']]."</strong>";
						...
						<dd class="icons">
							...
							<div><a class="plus" href="javascript:prime_open('<?php echo $no;?>');"><img width="13" height="13" alt="상세보기" src="../images/icon/icon_plus.png"></a></div>
									...
									<dt> 
							<a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>">
							<span style="text-align:left;"class="pt20 pl5 b logo"><?php echo $list['company_name'];?></span>
		...
		?>
				<li class="bth <?php echo $list['gold_service'];?>" id="prime_list_<?php echo $no;?>">
					<dl class="clearfix">
						<dt> 
							<a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>">					
							<span class="logo pl5" style="padding-top:17px;text-align: left; vertical-align: middle; display: table-cell;"><?php echo $list['company_name'];?></span>
							</a> 
						</dt>
						<dd class="text1 pt15"><?php echo $list['service_icon'];?><a href="<?php echo $alice['alba_path'];?>/alba_detail.php?no=<?php echo $no;?>"><?php echo $list['subject'];?> <span class="edy edyEn"><?php echo $list['volume'];?></span></a></dd>
						<dd class="text2 clearfix">
							<span class="pay">
								<?php
								if($list['wr_pay_conference']){
