...
$design_03_notice = $notice_control->get_notice_list_count(1);	// 디자인 03 공지사항 1건
?>
...
/* === search === */
#globalSearch{position:relative; width:958px; margin:0 auto; border:1px solid #ddd; padding:5px 0; }
...
.topKeyNotice{width:265px; height:20px; margin-top:5px; margin-left:20px; padding-left:30px; background:url("../images/icon/icon_keyword_2.gif") no-repeat 0 50%;}
.topKeyNotice li{float:left; padding:3px 5px; font-size:11px;}
/* === main navigation === */
...
#main_nav .mr_nav{line-height:32px; width:232px; height:37px; border:1px solid #ddd;}

#main_nav .mr_nav li{display:inline-block;zoom:1;*display:inline/*IE7 HACK*/; padding:0 6px; background:url("../images/main/bg_line_1.png") no-repeat scroll 0 50%; }
...
<script type="text/javascript" src="<?php echo $alice['main_path'];?>/skins/03/top.skin.js"></script>
...
<header id="firstheader" class="clearfix">
	...
	<div id="topBanner_question" style="display:none; cursor: default; z-index:999;">
		...
		<p align='center'>
			<span id='topBanner_questionAnswerYes'><input type="button" onClick="topBanner_questionAnswer('yes');" value="예" /> </span>
	...
	<div id="globalLogo" class="clearfix" style="display:block;">
		...
		<div class="fr"><?php echo ($logo_banner) ? stripslashes($logo_banner) : ''; // 로고 배너?></div>
	</div>

	<!--   메인메뉴영역   --> 
	<div id="main_nav" class="clearfix" style="display:block;">
		<div class="mainnavWrap">
			<ul class="ml_nav fr tc">
			...
			<ul class="mr_nav tl">
				...
				<li><a href="javascript:company_service(1);"><img src="../images/main/btn_nav_12.png" width="94" height="17" alt="채용공고등록"></a></li>
			</ul>
		</div>    
	</div>
		...
		<div class="search_wrap">
			...
			<input type="hidden" name="mode" value="search"/>
				...
				<dl>
					...
					<dd class="fl"><a href="javascript:serchFrm_submit();" class="bg_color4 btn" title="검색">검색</a></dd>
				</dl>
				</fieldset>
			</form>
			</div>
			<div class="topKeyNotice fl">
				<h4 class="blind">공지사항</h4>
				<ul>
					<li class="last"><a href="<?php echo $alice['board_path'];?>/notice_view.php?no=<?php echo $design_03_notice[0]['no'];?>"><?php echo stripslashes($design_03_notice[0]['wr_subject']);?></a></li>
				</ul>
			</div>
		</div>
	</div>
