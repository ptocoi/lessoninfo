<?php if (!defined("_ALICE_")) exit; // 개별 페이지 접근 불가 ?>
	...
	<script type="text/javascript" src="<?php echo $alice['main_path'];?>/skins/01/main.skin.js"></script>

	<?php /* content top */ ?>
	<div class="ct_top">
		<ul>
			<li class="width1 mr8 mb8 positionR">
				<h4>공지사항</h4>
				<em style="top:8px; right:8px;" class="positionA"><a href="<?php echo $alice['board_path'];?>/notice_list.php"><img width="42" height="15" alt="" src="../images/icon/icon_more1.gif" class="vb bg_color14"></a></em>
				<ul class="ctNotice clearfix">
					<?php 
						foreach($main_notice_list as $notice){ 
						$notice_cate = $category_control->get_categoryCodeName($notice['wr_type']);
						$wr_type = ($notice_cate) ? "[".$notice_cate."] " : "";
					?>
					<li class=""><a href="<?php echo $alice['board_path'];?>/notice_view.php?no=<?php echo $notice['no'];?>"><?php echo $wr_type;?><?php echo stripslashes($notice['wr_subject']);?></a></li>
					<?php } ?>
				</ul>
			</li>
