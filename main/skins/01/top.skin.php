...
<script type="text/javascript" src="<?php echo $alice['main_path'];?>/skins/01/top.skin.js"></script>
	...
	<div class="mainnavWrap" style="z-index:4000;">
		<ul class="ml_nav fl tl">
			...
			<div class="layGi positionA menu_layer clearfix" style="display:none; top:38px; left:0; z-index:5000;" >
				<h3 class="positionA" style="top:-38px; left:-2px;  width:190px; height:36px; line-height:33px; ">
			...
			<div class="layGg positionA menu_layer" style="display:none; top:38px; left:0; z-index:5000;" >
				<h3 class="positionA" style="top:-38px; left:189px; *left:182px;width:90px; height:36px; line-height:33px; ">
					...
					<div class="ggNav3">
						...
						<ul class="target clearfix pt5 pl5 pr5 pb5">
							<?php 
								...
								$name = $utility->remove_quoted($val['name']);	 // (쌍)따옴표 등록시 필터링
							?>
							<li><a href="<?php echo $alice['resume_path'];?>/alba_resume_target.php?type=<?php echo $val['code'];?>"><?php echo $name;?></a></li>
							<?php } ?>
						</ul> -->
					</div>
			...
			<div class="layPe positionA menu_layer" style="display:none; top:38px; left:0; z-index:5000;" >
				<h3 class="positionA" style="top:-38px; left:<?php echo ($is_adult)?'347':'278';?>px;*left:<?php echo ($is_adult)?'340':'270';?>px; width:102px; height:36px; line-height:33px; " id="layPe_position">
			...
			<div class="layCo positionA menu_layer" style="display:none; top:38px; left:0; z-index:5000;" >
				<h3 class="positionA" style="top:-38px; left:<?php echo ($is_adult)?'451':'382';?>px;*left:<?php echo ($is_adult)?'444':'370';?>px; width:102px; height:36px; line-height:33px; ">
