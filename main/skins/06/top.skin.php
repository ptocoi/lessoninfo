...
<script type="text/javascript" src="<?php echo $alice['main_path'];?>/skins/06/top.skin.js"></script>
...
<!--   채용정보버튼 레이어box   --> 
				...
				<h3 class="positionA" style="top:-38px; left:<?php echo ($is_adult)?'346':'277';?>px;*left:<?php echo ($is_adult)?'339':'269';?>px; width:102px; height:36px; line-height:33px; " id="layPe_position">
				...
				<h3 class="positionA" style="top:-38px; left:<?php echo ($is_adult)?'450':'381';?>px;*left:<?php echo ($is_adult)?'443':'369';?>px; width:102px; height:36px; line-height:33px; ">
