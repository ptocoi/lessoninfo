...
<section id="content" class="content_wrap clearfix">
	...
	<div class="keywordList positionR mt30 clearfix">
		<h2 class="clearfix pb5" style="border-bottom:1px solid #ddd;">
			<strong><img width="13" height="13" alt="" src="../images/icon/icon_arrow_4.png" class="vb bg_color4"> 채용정보 검색결과</strong>
		</h2>
		<div>
	...
	<div class="keywordList positionR mt30 clearfix">
		<h2 class="clearfix pb5" style="border-bottom:1px solid #ddd;">
			<strong><img width="13" height="13" alt="" src="../images/icon/icon_arrow_4.png" class="vb bg_color4"> 인재정보 검색결과</strong><em class="pl10">(총 <?php echo number_format($alba_resume_search['total_count']);?>건)</em>
		</h2>
		<div>
