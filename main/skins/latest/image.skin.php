...
<li class="list mt25">
	<div class="comImages list1 positionR" style="height:140px;">
		...
		<div class="positionR clearfix">
			...
			?>
				<li>
					<a href="<?php echo $alice['board_path']."/".$list[$i]['href_link'];?>" class="img"><img alt="" src="<?php echo $thumb_image;?>" class="vm" style=""></a>
					<a href="<?php echo $alice['board_path']."/".$list[$i]['href_link'];?>" class="title"><strong><?php echo $list[$i]['subject'];?></strong></a>
				</li>
			<?php } ?>
			</ul>
		</div>
