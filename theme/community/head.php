...
<div id="hd">
    ...
    <div id="hd_top">
        <div id="hd_tnb">
            ...
            <p class="hd_home"><a href="<?php echo G5_URL ?>">메인페이지로 가기</a></p>
        </div>
    </div>
    <div id="hd_wrapper">
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo1.gif" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
...
<div id="wrapper">
    ...
    <div id="aside_ct">
        <div class="short_cut">
            <ul>
                <li class="f_short_cut"><strong><a href="<?php echo G5_BBS_URL ?>/member_tch_confirm.php?url=<?php echo G5_BBS_URL ?>/register_tch_form.php&type=lesson">레슨 강사 신청 </a></strong></li>
                <li><strong><a href="<?php echo G5_BBS_URL ?>/member_tch_confirm.php?url=<?php echo G5_BBS_URL ?>/register_tch_form.php&type=instructor">학원 강사 신청 </a></strong></li>
    ...
    <div id="container">
    	<?php include_once (G5_THEME_PATH.'/banner.php'); ?>
