...
<div class="mbskin">
    ...
    <input type="hidden" name="mb_level" value="6">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="reg_mb_work_type">근무형태<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="radio" id="reg_mb_work_type1" name="mb_work_type" value="all" required checked="checked" class="required"> 전임 
                <input type="radio" id="reg_mb_work_type2" name="mb_work_type" value="part" required class="required"> 파트
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><label for="reg_mb_year">나이(출생년도)<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td><textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile']?"required":""; ?> style="height: 100px" class="<?php echo $config['cf_req_profile']?"required":""; ?>" placeholder="		취업을 결정짓는 가장 큰요소는 화려한 이력이나 경력이 아닙니다.
               본인을 자세하게 잘 표현한 따뜻한 자기소개서가 가장 중요한 요소입니다.
               채용하는 사람을 미소짓게하고 마음을 움직일수있는 자신만의 소개를 부탁해요"><?php echo $member['mb_profile'] ?></textarea></td>
        </tr>
