...
if(!defined('_CM_LAYOUT_'))
    define('_CM_LAYOUT_', true);
...
<header class="clearfix">
    ...
    <button type="button" id="mbutton" class="navbar-toggle offcanvas-toggle pull-right" data-toggle="offcanvas" data-target="#top_bar">
    ...
    <nav id="top_bar" class="navbar navbar-default navbar-offcanvas navbar-offcanvas-right navbar-offcanvas-touch navbar-offcanvas-fade" role="navigation">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?php echo G5_URL; ?>"><?php echo $config['cf_title']; ?></a>
                <button type="button" class="navbar-toggle offcanvas-toggle pull-right" data-toggle="offcanvas" data-target="#top_bar" style="float:left;">
                    <span class="sr-only">Toggle navigation</span>
                ...
                <ul class="nav navbar-nav">
                    ...
                    foreach($menus as $menu_item) {
                        ...
                        if(empty($menu_item['sub_menu'])) {
                            echo '<li class="'.$is_active_menu.'"><a href="'.$menu_item['url'].'" target="_'.$menu_item['target'].'">'.$menu_item['name'].'</a></li>'.PHP_EOL;
                        } else {
                            echo '<li class="dropdown '.$is_active_menu.'"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">'.$menu_item['name'].' <span class="caret"></span></a>'.PHP_EOL;
                            echo '<ul class="dropdown-menu" role="menu">'.PHP_EOL;
                            foreach($menu_item['sub_menu'] as $sub_menu) {
                                echo '<li><a href="'.$sub_menu['url'].'" target="_'.$sub_menu['target'].'">'.$sub_menu['name'].'</a></li>'.PHP_EOL;
                            }
                            echo '</ul>'.PHP_EOL;
                            echo '</li>'.PHP_EOL;
                        }
...
<?php if(0) { ?>
<nav id="top_bar" class="navbar navbar-default navbar-fixed-top navbar-offcanvas navbar-offcanvas-touch navbar-offcanvas-fade">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/">BYFUN.COM</a>
    </div>
...
<?php
if($cm_sub_title) {
  echo '<div id="sub_title">';
  echo '<div id="sub_title_body" class="container">';
  echo $cm_sub_title;
  echo '</div>';
  echo '</div>';
}
