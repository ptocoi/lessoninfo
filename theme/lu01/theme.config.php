...
$theme_config = array(
    ...
    'preview_board_skin'        => 'cm01', // 테마 미리보기 때 적용될 기본 게시판 스킨
    'preview_mobile_board_skin' => 'cm01', // 테마 미리보기 때 적용될 기본 모바일 게시판 스킨
    'cf_member_skin'            => 'cm01', // 회원 스킨
    'cf_mobile_member_skin'     => 'cm01', // 모바일 회원 스킨
