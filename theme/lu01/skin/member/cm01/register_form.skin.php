...
<!-- 회원정보 입력/수정 시작 { -->
    ...
    <form role="form" id="fregisterform" name="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="form-group">
      <label for="reg_mb_id">아이디<strong class="sound_only">필수</strong></label>
        <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="form-control minlength_3 <?php echo $required ?> <?php echo $readonly ?>" maxlength="20"/>
    ...
    <div class="form-group">
      ...
      <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="form-control minlength_3 <?php echo $required ?>" maxlength="20"/>
    </div>
    <div class="form-group">
      <label for="reg_mb_password_re">비밀번호 확인<strong class="sound_only">필수</strong></label>
      <input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="form-control minlength_3 <?php echo $required ?>" maxlength="20"/>
    </div>

    <h3>개인정보 입력</h3>
    <div class="form-group">
      <label for="reg_mb_name">이름<strong class="sound_only">필수</strong></label>
      <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo $member['mb_name'] ?>" <?php echo $required ?> <?php echo $readonly; ?> class="form-control <?php echo $required ?> <?php echo $readonly ?>" />
      <?php if ($config['cf_cert_use']) { ?>
      <span class="help-block">아이핀 본인확인 후에는 이름이 자동 입력되고 휴대폰 본인확인 후에는 이름과 휴대폰번호가 자동 입력되어 수동으로 입력할수 없게 됩니다.</span>
      <?php } ?>
      <?php
      if($config['cf_cert_use']) {
      echo '<div>';
          if($config['cf_cert_ipin'])
              echo '<button type="button" id="win_ipin_cert" class="btn btn-sm btn-primary">아이핀 본인확인</button>'.PHP_EOL;
          if($config['cf_cert_hp'])
              echo '<button type="button" id="win_hp_cert" class="btn btn-sm btn-primary">휴대폰 본인확인</button>'.PHP_EOL;
    ...
    <div class="form-group">
      ...
      <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?$member['mb_nick']:''; ?>" id="reg_mb_nick" required class="form-control required nospace" size="10" maxlength="20">
    ...
    <div class="form-group">
      ...
      <input type="text" name="mb_homepage" value="<?php echo $member['mb_homepage'] ?>" id="reg_mb_homepage" <?php echo $config['cf_req_homepage']?"required":""; ?> class="form-control <?php echo $config['cf_req_homepage']?"required":""; ?>" maxlength="255"/>
    </div>
    <?php }  ?>
    ...
    <div class="form-group">
        ...
        <input type="text" name="mb_tel" value="<?php echo $member['mb_tel'] ?>" id="reg_mb_tel" <?php echo $config['cf_req_tel']?"required":""; ?> class="form-control <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20">
    </div>
    <?php }  ?>
    ...
    <div class="form-group">
      ...
      <input type="text" name="mb_hp" value="<?php echo $member['mb_hp'] ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="form-control <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20">
    ...
    <div class="form-group">
      ...
      <div class="clearfix">  
        <div class="col-md-3 form-inline nopadding-left">
          ...
          <a href="<?php echo G5_BBS_URL ?>/zip.php?frm_name=fregisterform&amp;frm_zip1=mb_zip1&amp;frm_zip2=mb_zip2&amp;frm_addr1=mb_addr1&amp;frm_addr2=mb_addr2&amp;frm_addr3=mb_addr3&amp;frm_jibeon=mb_addr_jibeon" id="reg_zip_find" class="btn btn-sm btn-primary win_zip_find" target="_blank">주소 검색</a>
        </div>
        <div class="col-md-8">
          <input type="text" name="mb_addr1" value="<?php echo $member['mb_addr1'] ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr']?"required":""; ?> class="col-xs-6 form-control frm_address <?php echo $config['cf_req_addr']?"required":""; ?>">
        </div>
      </div>
      <p class="padding-10">
        <label for="reg_mb_addr1">기본주소<?php echo $config['cf_req_addr']?'<strong class="sound_only"> 필수</strong>':''; ?></label><br>
        <input type="text" name="mb_addr2" value="<?php echo $member['mb_addr2'] ?>" id="reg_mb_addr2" class="form-control frm_address">
        <label for="reg_mb_addr2">상세주소</label><br>
        <input type="text" name="mb_addr3" value="<?php echo $member['mb_addr3'] ?>" id="reg_mb_addr3" readonly="readonly" class="form-control frm_address">
    ...
    <div class="form-group">
        ...
        <textarea name="mb_signature" id="reg_mb_signature" <?php echo $config['cf_req_signature']?"required":""; ?> class="form-control <?php echo $config['cf_req_signature']?"required":""; ?>"><?php echo $member['mb_signature'] ?></textarea>
    </div>
    <?php }  ?>
    ...
    <div class="form-group">
        ...
        <textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile']?"required":""; ?> class="form-control <?php echo $config['cf_req_profile']?"required":""; ?>"><?php echo $member['mb_profile'] ?></textarea>
    </div>
    <?php }  ?>
    ...
    <div class="form-group">
      ...
      <?php }  ?>
      <div class="padding-left-10 help-block">
    ...
    <div class="form-group">
      ...
      <div class="checkbox nopadding autoheight">
