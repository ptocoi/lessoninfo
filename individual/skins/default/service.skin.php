...
<script type="text/javascript" src="<?php echo $alice['individual_path'];?>/skins/default/service.skin.js"></script>
			...
			<div class="personContentWrap"><!--  컨텐츠  -->
				<div id="listForm" class="positionR mt40 clearfix"> <!--  유료이용내역   --> 
					...
					<div class="customList1 mb30"> 
						...
						<colgroup><!-- <col width="10px"> --><col width="80"><col width="220"><col width="150"><col width="80"><col width="100"><col width="80"></colgroup>
						<thead>
						<tr>
						...
						<tr>
							...
							?>
								<div><span>
									<?php 
									if($_pay['service_code']=='etc_alba' || $_pay['service_code']=='etc_sms'){
