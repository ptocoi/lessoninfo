<?php
		/*
		* /application/individual/open_pay.php
		* @author Harimao
		* @since 2014/03/13
		* @last update 2015/04/02
		* @Module v3.5 ( Alice )
		* @Brief :: Member individual alba open paying
		* @Comment :: 개인회원 공고 열람권 결제 페이지
		*/
...
(
    [mode] => service_pay
    [sel_service] => etc_alba
    [etc_alba_date] => 1/month/40000/10/36000/0/day
    [total_price] => 36000
)
*/
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/open_pay.html'))
			include_once $alice['self'] . 'views/open_pay.html';
		else
			$config->error_info( $alice['self'] . 'views/open_pay.html' );
