		...
		<div style="display:none;" class="CashData1" id="bank_info">
			<ul class="clearfix">
				...
				<li class="">
					...
					<label><input type="checkbox" id="tax_use" class="check2" value="1" name="tax_use" onclick="tax_uses(this);">발급</label>
...
<input type="hidden" name="success_url" value="../../<?php echo $alice['individual_path'];?>/success.php"/>
<input type="hidden" name="no" value="<?php echo $no;?>"/>
<input type="hidden" name="pay_method" id="pay_method"/><!-- 결제수단 -->
<input type="hidden" name="return_url" value="../../<?php echo $alice['individual_path'];?>/alba_service.php"/>
