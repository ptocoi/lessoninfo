		...
		*/
		...
		switch($mode){
			...
			case 'update':
				...
				$vals['main_prime'] = $_POST['main_prime'];
				...
				*/
				...
				$vals['main_prime_use'] = ($_POST['main_prime_use']) ? $_POST['main_prime_use'] : 0;
				$vals['main_prime_limit'] = ($_POST['main_prime_limit']) ? $_POST['main_prime_limit'] : 0;
				$vals['main_prime_total'] = $_POST['main_prime_total'];
				$vals['main_prime_row'] = $_POST['main_prime_row'];
				$vals['main_prime_border'] = $_POST['main_prime_border'];
				$vals['main_prime_margin'] = $_POST['main_prime_margin'];
				$vals['main_prime_border_color'] = $_POST['main_prime_border_color'];
				$vals['main_prime_border_gold_color'] = $_POST['main_prime_border_gold_color'];
				$vals['main_prime_background_color'] = $_POST['main_prime_background_color'];
				$vals['main_prime_background_gold_color'] = $_POST['main_prime_background_gold_color'];
				//$vals['main_prime_content'] = $_POST['main_prime_content'];
