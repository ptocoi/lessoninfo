...
<!-- <input type="hidden" name="date_type" value="mb_wdate" id="date_type"/> -->
	...
	<tr>
		...
		<td class="pdlnb2" colspan="3">
			...
			<label><input name="pay_service[]" type="checkbox" value="main_prime" class="check" id="main_prime" <?php echo (@in_array('main_prime',$_GET['pay_service']))?'checked':'';?>>프라임</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_prime_gold" class="check" id="main_prime_gold" <?php echo (@in_array('main_prime_gold',$_GET['pay_service']))?'checked':'';?>>프라임 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_prime_logo" class="check" id="main_prime_logo" <?php echo (@in_array('main_prime_logo',$_GET['pay_service']))?'checked':'';?>>프라임 로고강조</label> &nbsp;
			...
			<label><input name="pay_service[]" type="checkbox" value="main_banner" class="check" id="main_banner" <?php echo (@in_array('main_banner',$_GET['pay_service']))?'checked':'';?>>배너형</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_banner_gold" class="check" id="main_banner_gold" <?php echo (@in_array('main_banner_gold',$_GET['pay_service']))?'checked':'';?>>배너형 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_list" class="check" id="main_list" <?php echo (@in_array('main_list',$_GET['pay_service']))?'checked':'';?>>리스트형</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_basic" class="check" id="main_basic" <?php echo (@in_array('main_basic',$_GET['pay_service']))?'checked':'';?>>메인 일반</label> &nbsp;
		</td>
	</tr>
	<tr>
		<td class="ctlt">채용(서브) 정보 서비스</td>
		<td class="pdlnb2" colspan="3">
			<label><input name="pay_service[]" type="checkbox" value="alba_platinum" class="check" id="alba_platinum" <?php echo (@in_array('alba_platinum',$_GET['pay_service']))?'checked':'';?>>플래티넘</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_platinum_gold" class="check" id="alba_platinum_gold" <?php echo (@in_array('alba_platinum_gold',$_GET['pay_service']))?'checked':'';?>>플래티넘 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_platinum_logo" class="check" id="alba_platinum_logo" <?php echo (@in_array('alba_platinum_logo',$_GET['pay_service']))?'checked':'';?>>플래티넘 로고강조</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_banner" class="check" id="alba_banner" <?php echo (@in_array('alba_banner',$_GET['pay_service']))?'checked':'';?>>배너형</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_banner_gold" class="check" id="alba_banner_gold" <?php echo (@in_array('alba_banner_gold',$_GET['pay_service']))?'checked':'';?>>배너형 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_list" class="check" id="alba_list" <?php echo (@in_array('alba_list',$_GET['pay_service']))?'checked':'';?>>리스트형</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_list_gold" class="check" id="alba_list_gold" <?php echo (@in_array('alba_list_gold',$_GET['pay_service']))?'checked':'';?>>리스트형 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_basic" class="check" id="alba_basic" <?php echo (@in_array('alba_basic',$_GET['pay_service']))?'checked':'';?>>채용정보 일반</label> &nbsp;
		</td>
	</tr>
	<tr>
		<td class="ctlt">인재정보 서비스</td>
		<td class="pdlnb2" colspan="3">
			<label><input name="pay_service[]" type="checkbox" value="main_focus" class="check" id="main_focus" <?php echo (@in_array('main_focus',$_GET['pay_service']))?'checked':'';?>>메인 포커스</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_focus_gold" class="check" id="main_focus_gold" <?php echo (@in_array('main_focus_gold',$_GET['pay_service']))?'checked':'';?>>메인 포커스 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_resume_focus" class="check" id="alba_resume_focus" <?php echo (@in_array('alba_resume_focus',$_GET['pay_service']))?'checked':'';?>>인재(서브) 포커스</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="alba_resume_focus_gold" class="check" id="alba_resume_focus_gold" <?php echo (@in_array('alba_resume_focus_gold',$_GET['pay_service']))?'checked':'';?>>인재(서브) 포커스 Gold</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="main_resume_basic" class="check" id="main_resume_basic" <?php echo (@in_array('main_resume_basic',$_GET['pay_service']))?'checked':'';?>>메인 인재정보 일반</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="resume_basic" class="check" id="resume_basic" <?php echo (@in_array('resume_basic',$_GET['pay_service']))?'checked':'';?>>인재(서브)정보 일반</label> &nbsp;
		</td>
	</tr>
	<tr>
		<td class="ctlt">채용정보 옵션서비스</td>
		<td class="pdlnb2" colspan="3">
	...
	<tr>
		...
		<td class="pdlnb2" colspan="3">
			<label><input name="pay_service[]" type="checkbox" value="etc_open" class="check" id="etc_open" <?php echo (@in_array('etc_open',$_GET['pay_service']))?'checked':'';?>>이력서열람권</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="etc_alba" class="check" id="etc_alba" <?php echo (@in_array('etc_alba',$_GET['pay_service']))?'checked':'';?>>채용정보열람권</label> &nbsp;
			<label><input name="pay_service[]" type="checkbox" value="etc_sms" class="check" id="etc_sms" <?php echo (@in_array('etc_sms',$_GET['pay_service']))?'checked':'';?>>SMS충전</label> &nbsp;
		</td>
	</tr>
	</table>
