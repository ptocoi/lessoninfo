...
<table class="sms">
	...
	<tr>
		<td class="contxt">
			<textarea name="send_msg" id="send_msg" onKeyUp="CountChar(this, 80);" required hname="문자내용"></textarea>
			<dt><span id="msg_bytes">0</span> Byte / <b>80Byte</b></dt>
		</td>
	</tr>
	<tr>
		<td class="connum">
			<strong>받는사람 <!-- (<span id="rphone_cnt">0</span>명) --></strong>
			<textarea id="rphone_list" style="height:100px;" name="rphone_list" required hname="받는사람"><?php echo ($mode=='sms')?$member['mb_hphone']."|".$member['mb_name']:"";?></textarea>
