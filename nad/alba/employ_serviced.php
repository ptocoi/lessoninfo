<?php
		...
		*/
		...
		//$con .= " and `wr_service_platinum_main_gold` < curdate() ";
		//$con .= " and `wr_service_platinum_main_logo` < curdate() ";
		$con .= " and `wr_service_platinum_sub` < curdate() ";
		//$con .= " and `wr_service_platinum_sub_gold` < curdate() ";
		//$con .= " and `wr_service_platinum_sub_logo` < curdate() ";
		$con .= " and `wr_service_prime` < curdate() ";
		//$con .= " and `wr_service_prime_main_gold` < curdate() ";
		//$con .= " and `wr_service_prime_main_logo` < curdate() ";
		$con .= " and `wr_service_grand` < curdate() ";
		//$con .= " and `wr_service_grand_main_gold` < curdate() ";
		//$con .= " and `wr_service_grand_main_logo` < curdate() ";
		$con .= " and `wr_service_banner` < curdate() ";
		//$con .= " and `wr_service_banner_main_gold` < curdate() ";
		//$con .= " and `wr_service_banner_sub` < curdate() ";
		$con .= " and `wr_service_banner_sub_gold` < curdate() ";
		//$con .= " and `wr_service_list` < curdate() ";
		//$con .= " and `wr_service_list_main_gold` < curdate() ";
		$con .= " and `wr_service_list_sub` < curdate() ";
		//$con .= " and `wr_service_list_sub_gold` < curdate() ";
		//$con .= " and `wr_service_busy` < curdate() ";

		$con .= " and `wr_service_basic` < curdate() ";
		$con .= " and `wr_service_basic_sub` < curdate() ";

 /*
		$con .= " and `wr_service_neon` < curdate() ";
		$con .= " and `wr_service_bold` < curdate() ";
		$con .= " and `wr_service_color` < curdate() ";
		$con .= " and `wr_service_icon` < curdate() ";
		$con .= " and `wr_service_blink` < curdate() ";
		$con .= " and `wr_service_jump` < curdate() ";
*/
		$con .= " ) ";
