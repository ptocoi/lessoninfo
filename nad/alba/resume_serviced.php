<?php
		...
		*/
		...
		//$con .= " and `wr_service_main_focus_gold` < curdate() ";
		$con .= " and `wr_service_sub_focus` < curdate() ";
		//$con .= " and `wr_service_sub_focus_gold` < curdate() ";
...
/*
		...
		$con .= " and `wr_service_focus` < curdate() ";
