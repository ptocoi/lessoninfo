		...
		*/
					...
					if($result){
						...
						if($mode=='load'){
							...
							for($i=0;$i<=4;$i++){
								...
								$photo_vals['data_no'] = $last_no;
								$photo_vals['photo_table'] = "alba";
								$photo_vals['photo_no'] = $i;
								$photo_vals['photo_source'] = $photo_vals['photo_name'] = "";
								$photo_vals['photo_filesize'] = $photo_vals['photo_width'] = $photo_vals['photo_height'] = $photo_vals['photo_type'] = 0;
								$photo_vals['photo_datetime'] = $now_date;
								$user_control->user_photo_insert($photo_vals);
							}
			...
			case 'alba_photo_upload':
				...
				if($photo_list){	// 사진 데이터가 있다면 alba_photos 를 기준으로 수정
					...
					$vals['mb_type'] = ($get_member['mb_type']) ? $get_member['mb_type'] : "company";
					$vals['mb_id'] = $mb_id;
			...
			case 'service':
				...
				if($is_array){
					...
					for($i=0;$i<$nos_cnt;$i++){
						...
						$pay_vals['pay_main_prime_logo_effect'] = $_POST['prime_logo_effect'];
						...
						$vals['wr_service_prime'] = $_POST['wr_service_prime'];
						$vals['wr_service_prime_main_gold'] = $_POST['wr_service_prime_main_gold'];
						$vals['wr_service_prime_main_logo'] = $_POST['wr_service_prime_main_logo'];
						...
						$vals['wr_service_banner'] = $_POST['wr_service_banner'];
						$vals['wr_service_banner_main_gold'] = $_POST['wr_service_banner_main_gold'];
						$vals['wr_service_banner_sub'] = $_POST['wr_service_banner_sub'];
						$vals['wr_service_banner_sub_gold'] = $_POST['wr_service_banner_sub_gold'];

						$vals['wr_service_list'] = $_POST['wr_service_list'];
						$vals['wr_service_list_main_gold'] = $_POST['wr_service_list_main_gold'];
						$vals['wr_service_list_sub'] = $_POST['wr_service_list_sub'];
						$vals['wr_service_list_sub_gold'] = $_POST['wr_service_list_sub_gold'];

						$vals['wr_service_basic'] = $_POST['wr_service_basic'];
						$vals['wr_service_basic_sub'] = $_POST['wr_service_basic_sub'];
