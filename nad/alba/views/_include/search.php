...
<input type="hidden" name="page_rows" value="<?php echo $page_rows;?>" id="page_rows"/>
	...
	<tr>
		...
		<td class="pdlnb2" colspan="3">
			...
			<label><input name="wr_service[]" type="checkbox" value="prime" class="check" id="wr_service_prime" <?php echo (@in_array('prime',$wr_service))?'checked':'';?>/>프라임</label>
			...
			<label><input name="wr_service[]" type="checkbox" value="banner" class="check" id="wr_service_banner" <?php echo (@in_array('banner',$wr_service))?'checked':'';?>/>배너형</label>
			...
			<label><input name="wr_service[]" type="checkbox" value="list" class="check" id="wr_service_list" <?php echo (@in_array('list',$wr_service))?'checked':'';?>/>리스트형</label>
