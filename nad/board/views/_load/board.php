...
?>
				...
				*/
				...
				<div id="add_form" class="bocol lnb_col" style="top:0%;left:28%;display:none;">
					...
					<form name="boardFrm" method="post" id="boardFrm" action="./process/board.php" enctype="multipart/form-data">
					...
					<tr class="secret_check">
						...
						<td class="pdlnb2">
							<!-- 추천  --><label><input type="checkbox" name="bo_use_good" class="check use_good" value="1" <?php echo ($use_good)?'checked':'';?>>사용함</label><!-- &nbsp;&nbsp;/&nbsp;&nbsp;
					...
					<tr>
						...
						<td class="pdlnb2">
							<?php echo $utility->make_cheditor('bo_content_head', $board['bo_content_head']);	// 에디터 생성?>
						</td>
					</tr> 
					<tr>
						<td class="ctlt">게시판 하단내용</td>
						<td class="pdlnb2">
							<?php echo $utility->make_cheditor('bo_content_tail', $board['bo_content_tail']);	// 에디터 생성?>
						</td>
					</tr>
					<tr><td colspan="2" height="5" class="wbg lnb"></td></tr>
					<tr>
						...
						<td class="pdlnb2">
							<?php echo $utility->make_cheditor('bo_insert_content', $board['bo_insert_content']);	// 에디터 생성?>
						</td>
					</tr>
					<tr><td colspan="2" height="5" class="wbg lnb"></td></tr>
...
?>
				...
				<form name="boardFrm" method="post" id="boardFrm" action="./process/regist.php" enctype="multipart/form-data">
				<input type="hidden" name="mode" value="<?php echo $mode;?>"/>
				<input type="hidden" name="ajax" value="1"/><!-- ajax mode 유무 -->				
				...
				<input type="hidden" name="wr_category" value="<?php echo $get_view['wr_category'];?>"/>
					...
					<tr>
						...
						<td class="pdlnb2">
							...
							<!-- <input name="wr_secret" type="checkbox" value="1"><label class="m">비밀글</label> -->
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="ctlt">내용</td>
						<td class="pdlnb2"><?php echo $utility->make_cheditor('wr_content', "");	// 에디터 생성?></td>
					</tr>
					<?php if($board['bo_use_upload']){ ?>
					<tr>
						<td class="ctlt">
