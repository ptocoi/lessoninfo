<?php
		...
		*/
		...
		echo $utility->call_cheditor('bo_content_head', '100%', '120px');
		echo $utility->call_cheditor('bo_content_tail', '100%', '120px');
		echo $utility->call_cheditor('bo_insert_content', '100%', '120px');
