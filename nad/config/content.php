<?php
		...
		*/
		...
		$type_arr = array( 'site_introduce'=>'사이트소개', 'site_agreement'=>'이용약관', 'site_privacy'=>'개인정보취급방침', 'board_criterion'=>'게시판관리기준', 'email_denied'=>'이메일무단수집거부', 'site_bottom'=>'사이트하단', 'email_bottom'=>'메일하단' );
